...
public class Linear extends Skill {

	public Linear() {
		super(true, "Linear", Material.RABBIT_FOOT, "linear", "R", "R", "R", "R", "R");
		setDescription("Thrust Forward dealing", "damage and knockback", "Pattern: R R R R R");
	}
	
	@Override
	public void useSkill(Player pl) {
		pl.setVelocity(pl.getEyeLocation().getDirection().multiply(3));
